  ...
  return (
    <ProjectLayout>
      ...
      <div className="project-content">
        ...
        <p>
          This project not only helped me become more comfortable with Axios but also introduced me to web sockets, Amazon S3, and system architecture. While the tech stack above sounds straightforward, our team spent a lot of time researching which tools to use for our needs, and we had to pivot a few times to accommodate cost and usage constraints. This was my first time working with a team to ideate, design, and develop a project from start to finish, and I thoroughly enjoyed the process of learning how to delegate development and design tasks, scope requirements, and implement features. The development and leadership skills I gained from this project
